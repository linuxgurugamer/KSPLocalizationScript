...
NOTE:  THIS FILE CONTAINS BRIEF INSTRUCTIONS, MORE COMPLETE INSTRUCTIONS ARE IN THE FILE:
...
KSPLocalizer.exe  <PROJECTDIR> --prefix="<PREFIX>" --outdir="<OUTPUT_DIRECTORY>"
