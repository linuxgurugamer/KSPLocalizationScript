...
// Generates Localization/en-us.cfg and Localization/en-us.csv, and
// keeps .bak backups so you can revert with --revert.
// ------------------------------------------------------------
// Usage
//   dotnet run -- "<GameData path>" <Prefix> [--maxLength=N] [--revert]
// ------------------------------------------------------------
...
internal static class KSPCFGPartLocalizer
{
    ...
    private static void WriteCfgFile(string path, IDictionary<string, KSPLocalizer.Literal> keyToText, KSPLocalizer.Origin origin)
    {
        ...
        sw.WriteLine("// Autogenerated by KSP_Part_Localizer");
